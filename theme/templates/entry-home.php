...
<span class="prompt">$</span> docker compose up -d &amp;&amp; docker compose exec app php bin/nimbus install</code></pre>
    ...
    <p class="hero-proof"><a class="hero-proof-link" href="https://danmat.dev" target="_blank" rel="noopener">danmat.dev</a> runs on NimbusCMS with <strong>no admin account at all</strong> &mdash; an agent operates the whole site over MCP.</p>
  </div>
</section>
